    ...
    <div className="content-page">
      ...
      <div className="mt-6">
        ...
        <ul className="list-disc list-inside pl-4 mt-2 text-gray-600 space-y-2">
          ...
          <li>Switched from direct SMTP to transactional email APIs (Brevo/Resend) to solve platform firewall issues.</li>
          <li>Switched to a "headless" Google Form for the listserv to radically simplify the signup architecture.</li>
        </ul>
      </div>
