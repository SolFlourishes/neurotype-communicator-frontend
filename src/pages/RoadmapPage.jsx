...
function RoadmapPage() {
  return (
    <div className="content-page">
      <h1 className="text-3xl font-bold mb-4 text-gray-800 border-b pb-3">Application Roadmap</h1>
      ...
      <div className="bg-blue-50 p-6 rounded-lg mt-8 border border-blue-200">
          <h2 className="flex items-center text-2xl font-semibold mb-4 text-blue-800">Current Phase: Alpha Version</h2>
      ...
      <div className="bg-green-50 p-6 rounded-lg mt-8 border border-green-200">
          <h2 className="flex items-center text-2xl font-semibold mb-4 text-green-800">Next Phase: Beta Version</h2>
